...
| endOfLine                          | String  | default            | The newline character used at the end of each line. On macOS, `default` selects LF. Other values are `lf` and `crlf`.                                        |
...
| hideQuickInsertHint                | Boolean | true               | Hide hint for quickly creating paragraphs                                                                                                                                      |
