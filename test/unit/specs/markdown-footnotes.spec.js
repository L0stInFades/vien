...
[^foo1]:
  ...
  it('Footnote with multiline text and list elements', () => {
    const expected = [
      ...
      { type: 'paragraph', text: 'At vero eos et accusam et justo duo dolores et ea rebum!' },
      { type: 'space' },
      { type: 'list_start', ordered: false, listType: 'bullet', start: '', blankLineBefore: true },
      { checked: undefined, listItemType: 'bullet', bulletMarkerOrDelimiter: '-', blankLineBefore: false, type: 'list_item_start' },
